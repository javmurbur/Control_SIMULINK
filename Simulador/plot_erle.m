...
set(erle.Motor0,'xdata',erle.Xtemp+erle.X_GF,'ydata',+(erle.Ytemp+erle.Y_GF),'zdata',-(erle.Ztemp-erle.Z_GF-2*t));

[erle.Xtemp,erle.Ytemp,erle.Ztemp] = rotateBFtoGF(erle.Motor1X,erle.Motor1Y,erle.Motor1Z,roll,pitch,yaw);
set(erle.Motor1,'xdata',erle.Xtemp+erle.X_GF,'ydata',+(erle.Ytemp+erle.Y_GF),'zdata',-(erle.Ztemp-erle.Z_GF-2*t));

[erle.Xtemp,erle.Ytemp,erle.Ztemp] = rotateBFtoGF(erle.Motor2X,erle.Motor2Y,erle.Motor2Z,roll,pitch,yaw);
set(erle.Motor2,'xdata',erle.Xtemp+erle.X_GF,'ydata',+(erle.Ytemp+erle.Y_GF),'zdata',-(erle.Ztemp-erle.Z_GF-2*t));

[erle.Xtemp,erle.Ytemp,erle.Ztemp] = rotateBFtoGF(erle.Motor3X,erle.Motor3Y,erle.Motor3Z,roll,pitch,yaw);
set(erle.Motor3,'xdata',erle.Xtemp+erle.X_GF,'ydata',+(erle.Ytemp+erle.Y_GF),'zdata',-(erle.Ztemp-erle.Z_GF-2*t));
